...
<div style="display: flex; gap: 1.5em; justify-content: center; align-items: flex-start; flex-wrap: wrap;">
  ...
  <figure style="flex: 0 1 55%; margin: 0; text-align: center;">
    ...
    <figcaption style="width: 100%; margin-top: 0.4em; text-align: center; font-size: 0.9em;">
      Beam syste in Gatti Wool Factory, by Pier Luigi Nervi, Rome 1953
    </figcaption>
  </figure>
...
It may happen that optimal \\(\sigma\\) concentrates on a 1D set. In that case we say that \\(\sigma\\) is a finite beam system or a *grillage*. More generally, we call the bending moment measure \\(\sigma\\) a beam system whenever it is a superposition of a (possibly uncountable) family of 1D tensor measures -- beams.
