...
In a plane, \\(d=2\\), the problem has a mechanical interpretation. Solution(s) \\( \sigma \\) is the <a href="https://en.wikipedia.org/wiki/Bending_of_plates" target="_blank" rel="noopener noreferrer">bending moment tensor</a> in the optimal (stiffest) ceiling. This design formulation builds upon the famous <a href="https://hal.science/file/index/docid/528973/filename/bouchitte-gangbo-seppecher.pdf" target="_blank" rel="noopener noreferrer">Michell problem</a> and can be viewed as its plate variant.
