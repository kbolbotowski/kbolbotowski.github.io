...
$$
	Z_2(\mu,\nu) = \min_{\substack{\gamma \in\mathcal{P}(\mathbb{R}^d \times \mathbb{R}^d \\ q \in \mathcal{M}( \mathbb{R}^d \times \mathbb{R}^d;\mathbb{R}^d) )}}\left\\{ \iint \frac{1}{2}\Big(\left|\tfrac{dq}{d\gamma}-x\right|^2 + \left|\tfrac{dq}{d\gamma}-y\right|^2 \Big) d\gamma \ : \ 
	\begin{array}{l}
		\pi_1^\\# \gamma = \mu, \\
		\pi_2^\\# \gamma=\nu,
